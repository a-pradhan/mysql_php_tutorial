...
{
    $output = "<table><tr><th>Username</th><th>Actions</th></tr>";
    ...
    while ($admin = mysqli_fetch_assoc($admin_set)) {
        ...
        $output .= "</td>";
        $output .= "<td>";
        $output .= "<a href=\"edit_admin.php?admin_id={$admin["id"]}\">Edit</a>&nbsp;";
        $output .= "<a href=\"delete_admin.php?admin_id={$admin["id"]}\">Delete</a>";
        $output .= "</td>";
        $output .= "</tr>";
    }
    $output .= "</table >";
